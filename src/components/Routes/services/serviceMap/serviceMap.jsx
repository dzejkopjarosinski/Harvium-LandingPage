...
const ServiceMap = () => {
    return (
        <section className='w-full bg-black flex justify-end gap-16'>
            <div className='text-left max-w-[576px] space-y-5 mx-5 text-lg font-normal'>
                <Reveal>
                    <h2 className='text-5xl py-5 font-bold'>Lorem ipsum</h2>
                </Reveal>
                <Reveal>
