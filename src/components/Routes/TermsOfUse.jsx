...
export default function TermsOfUse() {
  return (
    <div>
      <NavBar />
        <div className="bg-background-primary min-h-[850px] flex md:flex-row flex-col justify-center">
            <div className='flex flex-col justify-start items-center text-white pt-10'>   
                <h1 className='lg:text-5xl text-4xl font-bold items-center mt-14 md:gap-6'>Terms Of Use</h1>
                <p className=' text-lg mt-2 md:ml-3 non-italic pr-7 pl-7'>I. Administrator danych osobowych
Informujemy Państwa, że administratorem Państwa danych osobowych, jest spółka Harvium Sp. z o.o. w organizacji [dalej: Harvium lub Spółka]. Ze Spółką można skontaktować się:
•	Pisemnie na adres: Koszykowa 20, 82-500 Kwidzyn;
•	mailowo na adres poczty elektronicznej: contact@harvium.com
•	telefonicznie pod numerem: +48 784 852 271
W niniejszym dokumencie przez „Serwis” rozumie się serwis internetowy https://harvium.pl, zaś przez „Profile” rozumie się profile w portalach społecznościowych, takich jak Facebook czy LinkedIn.
