...
export default function About() {
  return (
    <>
    <NavBar />
    <div className="bg-background-primary h-screen flex flex-row">
        <div className="flex flex-col w-3/5 px-4 text-white">
          <div className='flex flex-col ml-10 mt-10'>
            <h1 className='lg:text-5xl text-4xl font-bold items-center gap-6'>O nas</h1>
            <div>
              <h2 className='text-3xl mt-10 font-semibold'>Kim jesteśmy?</h2>
              <p className='text-2xl mt-2 ml-3 non-italic'>Jesteśmy firmą handlową, która specjalizuje się w realizacji transakcji 
            ...
            <div>
              ...
              <p className='text-2xl mt-2 ml-3 non-italic'>Naszą misją jest tworzenie miejsca w którym popyt spotyka podaż. 
